...
import _root_.jp.lavans.skinnytest.model._
import _root_.org.joda.time._
import _root_.jp.lavans.skinnytest.controller._
  ...
  scalateTemplateConfig in Compile := {
    ...
    Seq(
      TemplateConfig(
        ...
        Seq("import jp.lavans.skinnytest.controller._", "import jp.lavans.skinnytest.model._"),
        Seq(
          Binding("context",
...
lazy val devBaseSettings = baseSettings ++ Seq(
  ...
  // Integration tests become slower when multiple jp.lavans.skinnytest.controller tests are loaded in the same time

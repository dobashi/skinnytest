...
ECHO.
ECHO   g/generate jp.lavans.skinnytest.controllerspec.controller : will generate jp.lavans.skinnytest.controllerspec.controller
ECHO   g/generate jp.lavans.skinnytest.model      : will generate jp.lavans.skinnytest.model
